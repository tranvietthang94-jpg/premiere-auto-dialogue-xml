...
Phase 11 trên branch `codex/phase11-calibrated-multimic-bleed` đã đạt local ở trạng thái shadow-ready. Slice 11A khóa corpus; 11B thêm calibrator có hướng; 11C nối scorer `120–250 ms`, minimum `2` cửa sổ/`75%`, project shadow và audit `1.7`; 11E qua HGE2 HEAD `73,658 giây / 299,4 MB` và full HGE `72 phút 31,005 giây / 1.435,1 MB`. Cả hai corpus có 42/42 pair thiếu support, mọi candidate `NoCalibration`, production changed/coverage mismatch/lost Enabled đều `0`; review CSV giữ nguyên hash Phase 10. Release đạt `171/171`; CI HEAD cuối còn chờ. Không mở adoption hoặc tăng production Disabled khi chưa có nhãn Target hợp lệ. Xem [PHASE11_CALIBRATED_MULTIMIC_BLEED.md](PHASE11_CALIBRATED_MULTIMIC_BLEED.md).
