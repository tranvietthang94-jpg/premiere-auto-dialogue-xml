...
Phase 11 đang thực hiện trên branch `codex/phase11-calibrated-multimic-bleed`. Slice 11A đã khóa corpus PCM tổng hợp 11 kịch bản và snapshot resolver một cửa sổ Phase 10. Slice 11B thêm calibrator delay/gain có hướng, minimum 3 anchor, robust outlier, leave-one-region-out, SHA-256 toàn evidence và output bounded 64/16; toàn bộ Release đạt `163/163`. Calibrator vẫn độc lập, chưa nối vào analyzer/audit/XML production. Bước tiếp theo là Slice 11C scorer nhiều cửa sổ và project shadow/audit `1.7`. Không thêm preview/UI; khi chưa có nhãn Target hợp lệ, candidate không được tăng production Disabled. Xem [PHASE11_CALIBRATED_MULTIMIC_BLEED.md](PHASE11_CALIBRATED_MULTIMIC_BLEED.md).
