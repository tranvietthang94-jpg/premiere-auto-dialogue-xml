...
- Từ hardening Phase 06, chuỗi VAD âm nhưng vẫn cao hơn noise floor ít nhất 10 dB liên tục tối thiểu 120 ms được coi là bằng chứng xung đột và giữ `Ambiguous`. Audit phân biệt reason `ambiguous-energy-vad-conflict`; transient ngắn hơn vẫn là noise.
