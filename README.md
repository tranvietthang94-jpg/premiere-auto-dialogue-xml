...
Phase 00–09 đã hoàn tất trên `main`. Phase 09 thêm resampler chống alias, shadow gate bảo thủ và validator trước XML; đạt HGE/Premiere round-trip/CI rồi merge qua PR `#12` tại `50ee4f9`. Phase 10 Slice 10A–10D đã thêm corpus, estimator background-eligible, VAD start/continue hysteresis, project merge bảo thủ hai tầng và audit `1.6` trên branch riêng. Candidate nay đã vào đường phân tích sản xuất nhưng chỉ qua fail-safe giữ mọi baseline Enabled; chưa có XML HGE2/full HGE hay Premiere pilot mới. Xem [docs/PHASE09_AUDIO_XML_HARDENING.md](docs/PHASE09_AUDIO_XML_HARDENING.md) và [docs/PHASE10_NOISE_BOUNDARY_STABILITY.md](docs/PHASE10_NOISE_BOUNDARY_STABILITY.md). Cổng nhãn nghe Mục tiêu được chủ dự án miễn, nên dự án không tuyên bố các tỷ lệ 100%/90%/0% chưa đo. RC1 hiện hành vẫn là bản đã qua Premiere round-trip A1–A7 và xác minh installer/signer nội bộ; Phase 10 chưa tự động tạo một release mới.
