...
Phase 11 đã hoàn tất nghiên cứu shadow tại candidate `d150f5a`, CI `31720635957`; Release `171/171`. HGE2/full HGE đều có 42/42 pair thiếu calibration support, nên mọi candidate là `NoCalibration`; production changed, coverage mismatch và lost Enabled đều `0`, M19 vẫn Enabled. HGE2 HEAD đạt `73,658 giây / 299,4 MB`; full HGE đạt `72 phút 31,005 giây / 1.435,1 MB`, dưới cổng; build/publish/installer CI đều đạt. Review ngày 2026-08-14 quyết định không merge/adopt Phase 11: hai corpus thật chưa cho thấy lợi ích chất lượng, trong khi audit tăng `33,6–34,0%` và peak RAM full HGE tăng `114,7 MB` so với Phase 10. Nhánh và evidence được giữ làm nghiên cứu; `main`, logic production và RC1 không đổi. Chưa được phép tăng tự động mute khi chưa có nhãn Target hợp lệ. Xem [docs/PHASE09_AUDIO_XML_HARDENING.md](docs/PHASE09_AUDIO_XML_HARDENING.md), [docs/PHASE10_NOISE_BOUNDARY_STABILITY.md](docs/PHASE10_NOISE_BOUNDARY_STABILITY.md) và [docs/PHASE11_CALIBRATED_MULTIMIC_BLEED.md](docs/PHASE11_CALIBRATED_MULTIMIC_BLEED.md). Cổng nhãn nghe Mục tiêu được chủ dự án miễn ở các phase trước, nên dự án không tuyên bố các tỷ lệ 100%/90%/0% chưa đo.
