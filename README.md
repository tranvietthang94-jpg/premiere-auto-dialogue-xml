...
Phase 00–10 đã hoàn tất về logic và bằng chứng bắt buộc. Phase 09 thêm resampler chống alias, shadow gate bảo thủ và validator trước XML. Phase 10 thêm estimator background-eligible, VAD start/continue hysteresis, project merge bảo thủ hai tầng, audit `1.6` có giới hạn bộ nhớ và XML compaction theo semantic audio; merge qua PR `#14` tại `19c6577`, CI hậu merge `31691393143` đạt. Synthetic, HGE2/full HGE, Premiere PCM A1–A7, M19, Final Cut Pro XML re-export và CI/installer đều đạt; so với Phase 09, coverage lệch `0` và không mất bất kỳ frame Enabled nào. Candidate HGE2 cuối có XML SHA-256 `6F855699ED6D39712F3118A661DCF18943750F805D3EDB662546D033A808910E`. Phase 11 đã đạt trạng thái shadow-ready tại candidate `d150f5a`, CI `31720635957`: corpus, directional calibrator, scorer `120–250 ms`, project shadow và audit `1.7`; Release `171/171`. HGE2/full HGE đều có 42/42 pair thiếu calibration support, nên mọi candidate là `NoCalibration`; production changed, coverage mismatch và lost Enabled đều `0`, M19 vẫn Enabled. HGE2 HEAD đạt `73,658 giây / 299,4 MB`; full HGE đạt `72 phút 31,005 giây / 1.435,1 MB`, dưới cổng; build/publish/installer CI đều đạt. Chưa được phép tăng tự động mute khi chưa có nhãn Target hợp lệ. Xem [docs/PHASE09_AUDIO_XML_HARDENING.md](docs/PHASE09_AUDIO_XML_HARDENING.md), [docs/PHASE10_NOISE_BOUNDARY_STABILITY.md](docs/PHASE10_NOISE_BOUNDARY_STABILITY.md) và [docs/PHASE11_CALIBRATED_MULTIMIC_BLEED.md](docs/PHASE11_CALIBRATED_MULTIMIC_BLEED.md). Cổng nhãn nghe Mục tiêu được chủ dự án miễn ở các phase trước, nên dự án không tuyên bố các tỷ lệ 100%/90%/0% chưa đo. RC1 hiện hành vẫn là bản phát hành nội bộ hiện hành; Phase 11 không tự động tạo hoặc thay thế release.
